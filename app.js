...
(function () {
  ...
  /* ── screenshot popup (open + dismiss only) ────────────── */
  ...
  if (lb) {
    ...
    var open = function (btn) {
      ...
      lbCap.firstChild.textContent = title;
      lbCap.lastChild.textContent = cap;
      lb.hidden = false;
    ...
    [].slice.call(document.querySelectorAll('.shot__btn')).forEach(function (b) {
